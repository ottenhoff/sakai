...
public final class DateFormatterUtil
{
	 ...
	 *
	 * @param inputDate The date that needs to be formatted.
	 * @param format    The given date-time format.
	 ...
	 *
	 * @param inputDate The string that needs to be parsed.
	 */
	 ...
	 *
	 * @param date The candidate String date.
	 *
